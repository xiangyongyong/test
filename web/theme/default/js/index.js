...
layui.config({
	base: basePath+'/theme/default/js/',
...
// 播放消息提示
swfobject.embedSWF(basePath+"/theme/default/lib/SwfObject/sound.swf", "sound", "1", "1", "9.0.0", basePath+"/theme/default/lib/SwfObject/expressInstall.swf", {}, {wmode: "transparent"}, {});

function playNotify() {
    var sound = swfobject.getObjectById("sound");
    if (sound) {
        sound.SetVariable("f", basePath+'/theme/default/lib/SwfObject/msg.mp3');
        sound.GotoFrame(1);
    }
}
